package com.github.gradlerouter.router_runtime
...
object Router {
    ...
    //编译期间生成的总映射表
    private const val GENERATER_MAPPING =
        "com/github/gradlerouter/mapping/generated/RouterMapping"
    ...
    fun init() {
        ...
        try {
            val clazz = Class.forName(GENERATER_MAPPING)
    ...
    fun go(context: Context, url: String) {
        ...
        if (context == null || url == null) {
            Log.i(TAG, "go: param erro.")
            return
        }

        //匹配URL,找到目标界面
        //eg: router://imooc/profile?name=imooc&message=hello
